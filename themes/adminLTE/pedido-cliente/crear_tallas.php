...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["pedido-cliente/crear_tallas_referencia", 'id' => $id, 'token' => $token,'id_referencia' => $id_referencia]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="buscarmaquina">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["pedido-cliente/crear_tallas_referencia", 'id' => $id, 'token' => $token, 'id_referencia' => $id_referencia]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
