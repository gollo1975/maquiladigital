        ...
        <div class="btn-group btn-sm" role="group">
           <button type="button" class="btn btn-default btn">  <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['index'], ['class' => 'btn btn-primary btn-sm']) ?>
            ...
            <?php }else{
                ...
                <?php }else{ ?>
                <button type="button" class="btn btn-default btn"> <?php echo Html::a('<span class="glyphicon glyphicon-print"></span> Imprir', ['/asignacion-producto/imprimiriOrdenProduccion', 'id' => $model->id_asignacion],['class' => 'btn btn-default btn-sm']) ;?>
                </button>        
