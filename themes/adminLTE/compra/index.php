...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("compra/index"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtro" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("compra/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
        ...
        <div class="panel-footer text-right" >            
            <?php
                ...
                <?= Html::submitButton("<span class='glyphicon glyphicon-export'></span> Exportar excel", ['name' => 'excel','class' => 'btn btn-default btn-sm ']); ?>                
                   <a align="right" href="<?= Url::toRoute("compra/create") ?>" class="btn btn-success btn-sm"><span class='glyphicon glyphicon-plus'></span> Nuevo</a> 
               <?php $form->end() ?>
        </div>
    </div>
</div>
