                        ...
                        <div class="panel-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    endforeach; ?>
                                <td colspan="4"><td style="font-size: 85%; width: 100px; text-align: right;"><b>Confe.:</b> <?= ''.number_format($total_confeccion)?> </td><td style="font-size: 85%; width: 100px; text-align: right;"><b>Faltan: </b><?= ''. number_format($model->cantidad - $total_confeccion,0) ?></td><td style="font-size: 85%; width: 160px; text-align: right;"><b>T. Segundos:</b> <?= ''.number_format($t_segundos,0) ?> </td><td style="font-size: 85%; width: 160px; text-align: right;"><b>T. Minutos:</b> <?= ''.number_format($t_minutos,0) ?></td> <td style="font-size: 85%; width: 170px; text-align: right; background: #4B6C67; color: #FFFFFF;"><b>T. Minutos conf.:</b> <?= ''.number_format($t_minutos_conf,0) ?></td> <td colspan="2">
                                </tbody>     
                            </table>
                        </div>    
                    </div>
