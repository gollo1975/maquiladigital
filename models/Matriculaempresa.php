...
class Matriculaempresa extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['dv', 'id_tipo_regimen', 'id_banco_factura', 'gran_contribuyente','agente_retenedor','vlr_minuto_vinculado','vlr_minuto_contrato','codigo_salario','aplica_auxilio','base_auxilio','codigo_salario_auxilio','codigo_salario_pago_produccion','ajuste_caja','codigo_concepto_compra','aplica_regla','porcentaje_minima_eficiencia','dias_trabajados'], 'integer'],
