...
class PedidosSearch extends Pedidos
{
    ...
    {
        return [
            [['id_pedido', 'numero_pedido', 'idcliente', 'total_unidades', 'valor_total', 'impuesto', 'total_pedido', 'autorizado', 'pedido_cerrado', 'generar_orden', 'pedido_anulado'], 'integer'],
            [['fecha_pedido', 'fecha_entrega', 'fecha_proceso', 'user_name', 'observacion'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            'pedido_anulado' => $this->pedido_anulado,
        ]);
