...
class PDF extends FPDF {
    ...
    function Header() {
        $id_nomina_electronicaacion = $GLOBALS['id_nomina_electronica'];
       ...
       $this->SetXY(43, 10);
        ...
        $this->Cell(30, 7, utf8_decode('N°. '($nomina->consecutivo. '-'.$nominas->numero_nomina_electronica)), 0, 0, 'l', 0);
       // $this->SetFillColor(200, 200, 200);
        $this->SetXY(10, 48);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("Documento:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(20, 5, utf8_decode($nomina->documento_empleado), 0, 0, 'L',1);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(25, 5, utf8_decode("Empleado:"), 0, 0, 'L', 1);
        $this->SetFont('Arial', '', 7);
        $this->Cell(50, 5, utf8_decode($nomina->nombre_completo), 0, 0, 'L', 1);
        $this->SetFont('Arial', 'B', 7);
