...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute(["producto/nuevodetalles", 'idproducto' => $idproducto, 'token' => $token]),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="costodiario">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["producto/nuevodetalles", 'idproducto' => $idproducto, 'token' => $token]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
...
<div class="table table-responsive">
    <div class="panel panel-success ">
        ...
        <div class="panel-footer text-right">
            <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['producto/view', 'id' => $idproducto, 'token' => $token], ['class' => 'btn btn-primary btn-sm']) ?>
