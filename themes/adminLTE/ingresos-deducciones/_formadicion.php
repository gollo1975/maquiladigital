        ...
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                ...
                <div class="panel-footer text-right">			
                    <a href="<?= Url::toRoute(["ingresos-deducciones/view", 'id'=>$id, 'fecha_inicio' => $fecha_inicio, 'fecha_corte' => $fecha_corte]) ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
