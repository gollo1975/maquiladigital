                        ...
                        <tr style="font-size: 85%;">
                            ...
                            <?php if($model->autorizado == 0){?>
                                <td style= 'width: 15px; height: 10px;'>
                                    <a href="<?= Url::toRoute(["valor-prenda-unidad/view_search_operaciones", "id" => $model->id_valor, 'idordenproduccion' => $model->idordenproduccion, 'id_planta' =>$model->id_planta,'id_detalle' => $val->iddetalleorden]) ?>" ><span class="glyphicon glyphicon-eye-open"></span></a>
                                </td>
                                <td style= 'width: 15px; height: 10px;'>
