        ...
        <div class="table table-responsive">
            <div class="panel panel-success ">
                <div class="panel-heading" style="text-align: left ">
                   Crear el SAM de induccion...
                </div>
                <div class="panel-body">
                   <div class="row">
                        <?= $form->field($model, 'tiempo_induccion')->dropdownList(['3' => '3', '5' => '5', '8' => '8', '10' => '10',  '15' => '15', '20' => '20','0' => '0'], ['prompt' => 'Seleccione (Minutos)', 'required' => true]) ?>
                    </div>    
                    <div class="row">
                    ...
                    <div class="panel-footer text-right">
                       <?= Html::submitButton("<span class='glyphicon glyphicon-send'></span> Crear", ["class" => "btn btn-primary", 'name' => 'enviar_sam']) ?>                    
                   </div>
            </div>
