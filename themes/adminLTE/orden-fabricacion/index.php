...
$this->title = 'Orden de fabricación';
...
<?php $formulario = ActiveForm::begin([
    "method" => "get",
    "action" => Url::toRoute("orden-fabricacion/index"),
...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="filtro" style="display:none">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute("orden-fabricacion/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
        ...
        <table class="table table-bordered table-hover">
            <thead>
                ...
                <th scope="col" style='background-color:#B9D5CE;'>numero pedido</th>
                 <th scope="col" style='background-color:#B9D5CE;'>Fecha fabricación</th>
            ...
            foreach ($modelo as $val):?>
                <tr style='font-size:85%;'>                
                    ...
                    <td><?= $val->pedido->numero_pedido ?></td>
                    <td><?= $val->fecha_fabricacion ?></td>
                    <td><?= $val->referencia->codigo ?></td>.
                    <td><?= $val->referencia->referencia ?></td>
                    <td style="text-align: right"><?= ''. number_format($val->cantidades,0) ?></td>
                   
                    <td style= 'width: 25px; height: 25px;'>
                            <a href="<?= Url::toRoute(["orden-fabricacion/view", "id" => $val->id_orden_fabricacion]) ?>" ><span class="glyphicon glyphicon-eye-open"></span></a>
                    </td>
