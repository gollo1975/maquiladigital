    ...
    public function rules()
    {
        return [
            ...
            [['id_grupo_pago', 'id_periodo_pago_nomina', 'id_contrato', 'id_empleado', 'cedula_empleado', 'nro_pago', 'dias_pago', 'estado_generado', 'estado_liquidado', 'estado_cerrado', 'salario_contrato', 'dia_real_pagado', 'salario_medio_tiempo',
                'vlr_ibp_medio_tiempo','total_pagar', 'total_auxilio_transporte', 'salario_promedio', 'total_ibc_no_prestacional','id_tipo_nomina','dias_ausentes','dias_vacacion','horas_vacacion','ibc_vacacion','ajuste_incapacidad','importar_prima',
                'pago_aplicado','documento_generado','documento_detalle_generado','ahorro_pagado'], 'integer'],
