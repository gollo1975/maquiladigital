...
<div class="panel panel-success">
    ...
    <div class="panel-body">
        ...
        <div class="row">
           <?= $form->field($model, 'fecha_notificacion')->widget(DatePicker::className(), ['name' => 'check_issue_date',
                'value' => date('d-M-Y', strtotime('+2 days')),
                'options' => ['placeholder' => 'Seleccione una fecha ...'],
                'pluginOptions' => [
                    'format' => 'yyyy-m-d',
        ...
        <div class="panel-footer text-right">                    
            <a href="<?= Url::toRoute("resolucion/index") ?>" class="btn btn-primary btn-sm"><span class='glyphicon glyphicon-circle-arrow-left'></span> Regresar</a>
