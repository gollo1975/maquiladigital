...
<div class="panel panel-success panel-filters">
    ...
    <div class="panel-body" id="buscarmaquina">
        ...
        <div class="panel-footer text-right">
            ...
            <a align="right" href="<?= Url::toRoute(["operarios/relacionmaquina", 'id' => $id, 'token' => $token]) ?>" class="btn btn-primary"><span class='glyphicon glyphicon-refresh'></span> Actualizar</a>
        </div>
    </div>
</div>
...
<div class="table table-responsive">
    <div class="panel panel-success ">
        ...
        <div class="panel-footer text-right">
            <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Regresar', ['operarios/view', 'id' => $id, 'token' => $token], ['class' => 'btn btn-primary btn-sm']) ?>
