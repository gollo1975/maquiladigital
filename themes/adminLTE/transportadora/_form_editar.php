...
$municipios = ArrayHelper::map(\app\models\Municipio::find()->orderBy('municipio ASC')->all(), 'idmunicipio', 'municipio');
...
?>
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <?= $form->field($model, 'idmunicipio')->dropDownList($municipios, ['prompt' => 'Seleccione...']) ?>
            </div>
            <div class="row">
